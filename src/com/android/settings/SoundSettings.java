...
public class SoundSettings extends SettingsPreferenceFragment implements
    ...
    private BroadcastReceiver mReceiverRing = new BroadcastReceiver() {
        @Override
    ...
    public void onResume() {
        ...
        IntentFilter filterRing = new IntentFilter(AudioManager.RINGER_MODE_CHANGED_ACTION);
        getActivity().registerReceiver(mReceiverRing, filterRing);
    ...
    public void onPause() {
        ...
        getActivity().unregisterReceiver(mReceiverRing);
